...
import 'package:aproxy/models/vpn_config.dart';
import 'package:aproxy/services/storage_service.dart';
...
void main() {
  group('VpnConfig', () {
    ...
    test('toProxyJson 含 proxy 原生键与 launcher_url', () {
      ...
      expect(map['dns_cache_size'], 200);
      expect(map['dns_cache_ttl'], 3600);
