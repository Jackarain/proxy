    ...
    Handler handler)
{
    ...
    detail::udp_session_start_receive(
        std::move(session), std::move(seq), total, sender, std::move(handler));
}
    ...
    Handler handler)
{
    ...
    detail::udp_session_start_send(
        std::move(session), remote, std::move(seq), total, std::move(handler));
}
