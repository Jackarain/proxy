...
def main(ctx):
  ...
  linux_cxx("CMAKE_TEST=True Job 14", "g++", packages="binutils-gold gdb libc6-dbg", buildscript="b5847f804b-a16f359ef1", buildtype="b5847f804b-a16f359ef1", image=linuxglobalimage, environment={'CMAKE_TEST': 'True', 'DRONE_JOB_UUID': 'fa35e19212'}, globalenv=globalenv),
  linux_cxx("COMMENT=codecov.io B2_CXXSTD=03,11 B2_TOOLSET Job 15", "g++-8", packages="g++-8", buildscript="b5847f804b-bbb3de2b00", buildtype="b5847f804b-bbb3de2b00", image=linuxglobalimage, environment={'COMMENT': 'codecov.io', 'B2_CXXSTD': '03,11', 'B2_TOOLSET': 'gcc-8', 'B2_DEFINES': 'define=BOOST_NO_STRESS_TEST=1', 'DRONE_JOB_UUID': 'f1abd67035'}, globalenv=globalenv),
  ...
  linux_cxx("COMMENT=valgrind B2_TOOLSET=clang-6.0 B2_CXXS Job 17", "clang++-6.0", packages="clang-6.0 libc6-dbg libc++-dev libstdc++-8-dev", llvm_os="xenial", llvm_ver="6.0", buildscript="b5847f804b-db180b7bd2", buildtype="b5847f804b-db180b7bd2", image=linuxglobalimage, environment={'COMMENT': 'valgrind', 'B2_TOOLSET': 'clang-6.0', 'B2_CXXSTD': '03,11,14,17,2a', 'B2_DEFINES': 'define=BOOST_NO_STRESS_TEST=1', 'B2_VARIANT': 'variant=debug', 'B2_TESTFLAGS': 'testing.launcher=valgrind', 'VALGRIND_OPTS': '--error-exitcode=1', 'DRONE_JOB_UUID': '0716d9708d'}, globalenv=globalenv),
  linux_cxx("COMMENT=Coverity Scan B2_TOOLSET=clang Job 18", "g++", packages="binutils-gold gdb libc6-dbg", buildscript="b5847f804b-cce9827eb5", buildtype="b5847f804b-cce9827eb5", image=linuxglobalimage, environment={'COMMENT': 'Coverity Scan', 'B2_TOOLSET': 'clang', 'DRONE_JOB_UUID': '9e6a55b6b4'}, globalenv=globalenv),
  ]
