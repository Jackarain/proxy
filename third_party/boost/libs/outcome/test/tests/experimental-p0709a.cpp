...
(C) 2017-2026 Niall Douglas <http://www.nedproductions.biz/> (7 commits)
...
using result = BOOST_OUTCOME_V2_NAMESPACE::experimental::status_result<T, E, BOOST_OUTCOME_V2_NAMESPACE::policy::all_narrow>;
...
protected:
  ...
  virtual bool _do_equivalent(const BOOST_OUTCOME_SYSTEM_ERROR2_NAMESPACE::status_code<void> &,
                              const BOOST_OUTCOME_SYSTEM_ERROR2_NAMESPACE::status_code<void> &) const noexcept override final
  {
    return false;
  }  // NOLINT
  ...
  _do_throw_exception(const BOOST_OUTCOME_SYSTEM_ERROR2_NAMESPACE::status_code<void> &) const override final
  {
    abort();
  }  // NOLINT
};
