...
lexem const lexems[] = 
{
    ...
    { "\"\\a\\b\\e\\E\\f\\n\\r\\t\\v escape sequences \\?\\'\\\\\"", boost::wave::T_STRINGLIT },
    { "&&", boost::wave::T_ANDAND },
...
//    { "#include SOME_HEADER", boost::wave::T_PP_INCLUDE },
    ...
    { "123'4.1'2e1fl", boost::wave::T_FLOATLIT },
    { "1234LL", boost::wave::T_LONGINTLIT },
    { "1234ll", boost::wave::T_LONGINTLIT },
    { "12'34ll", boost::wave::T_LONGINTLIT },
