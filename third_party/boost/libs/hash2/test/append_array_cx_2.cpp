...
int main()
{
    ...
    TEST_EQ( (test<fnv1a_32, little_endian_flavor>( std::array<int, 4>{{ 1, 2, 3, 4 }} )), 1041505217 );
    TEST_EQ( (test<fnv1a_32, big_endian_flavor>( std::array<int, 4>{{ 1, 2, 3, 4 }} )), 3216558841 );
