...
.Fixes
* {issue}1160[#1160] Fixed UB in `value::emplace_` functions.
* {issue}1166[#1166] Fixed self-insert in `string::insert`.
* {issue}1167[#1167] Fixed self-insert in `array::insert` and `array::resize`.
* {issue}1168[#1168] Fixed self-append in `string::append`.
