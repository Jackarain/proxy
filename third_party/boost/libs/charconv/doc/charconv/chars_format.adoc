...
If the precision of `to_chars` exceeds that of the type (e.g. `std::numeric_limits<double>::max_digits10`), 0s will be appended to the end of the significant digits.
...
=== General
General format will be the shortest representation of a number in either fixed or scientific format (e.g. `1234` instead of `1.234e+03`).
