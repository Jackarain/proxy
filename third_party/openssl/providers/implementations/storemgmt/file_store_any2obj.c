...
#ifndef any2obj_set_ctx_params_list
static const OSSL_PARAM any2obj_set_ctx_params_list[] = {
    OSSL_PARAM_utf8_string(OSSL_OBJECT_PARAM_DATA_STRUCTURE, NULL, 0),
    OSSL_PARAM_END
};
#endif

#ifndef any2obj_set_ctx_params_st
struct any2obj_set_ctx_params_st {
    OSSL_PARAM *datastruct;
};
#endif

#ifndef any2obj_set_ctx_params_decoder
static int any2obj_set_ctx_params_decoder
    (const OSSL_PARAM *p, struct any2obj_set_ctx_params_st *r)
{
    const char *s;
