...
#ifndef spki2typespki_set_ctx_params_list
...
#ifndef spki2typespki_set_ctx_params_st
struct spki2typespki_set_ctx_params_st {
    OSSL_PARAM *propq;
};
#endif

#ifndef spki2typespki_set_ctx_params_decoder
static int spki2typespki_set_ctx_params_decoder
    (const OSSL_PARAM *p, struct spki2typespki_set_ctx_params_st *r)
{
    const char *s;
