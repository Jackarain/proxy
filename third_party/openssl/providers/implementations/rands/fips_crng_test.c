...
#ifndef crng_test_get_ctx_params_list
static const OSSL_PARAM crng_test_get_ctx_params_list[] = {
...
#ifndef crng_test_get_ctx_params_st
struct crng_test_get_ctx_params_st {
# if defined(FIPS_MODULE)
    OSSL_PARAM *ind;
# endif
    OSSL_PARAM *maxreq;
...
#ifndef crng_test_get_ctx_params_decoder
static int crng_test_get_ctx_params_decoder
    (const OSSL_PARAM *p, struct crng_test_get_ctx_params_st *r)
{
    const char *s;
