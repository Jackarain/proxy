...
static const char compiler_flags[] = {
    ...
    '-','p','c','-','l','i','n','u','x','-','g','n','u','-','g','c',
    'c',' ','-','f','P','I','C',' ','-','p','t','h','r','e','a','d',
    ' ','-','m','6','4',' ','-','W','a',',','-','-','n','o','e','x',
    'e','c','s','t','a','c','k',' ','-','p','i','p','e',' ','-','f',
    'n','o','-','s','t','r','i','c','t','-','a','l','i','a','s','i',
    'n','g',' ','-','W','a',',','-','-','n','o','e','x','e','c','s',
    't','a','c','k',' ','-','O','3',' ','-','m','a','r','c','h','=',
    'n','a','t','i','v','e',' ','-','p','i','p','e',' ','-','f','n',
    'o','-','s','t','r','i','c','t','-','a','l','i','a','s','i','n',
    'g',' ','-','W','a',',','-','-','n','o','e','x','e','c','s','t',
    'a','c','k',' ','-','D','O','P','E','N','S','S','L','_','U','S',
    ...
    'D','E','B','U','G',' ',' ','-','D','O','P','E','N','S','S','L',
    '_','N','O','_','B','U','F','_','F','R','E','E','L','I','S','T',
    'S','\0'
};
